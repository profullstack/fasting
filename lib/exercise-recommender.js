...
- Calories burned are realistic for the exercise type and duration
  ...
  try {
    const response = await client.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a knowledgeable fitness trainer who provides safe, effective exercise recommendations. Always respond with ONLY valid JSON in the exact format requested. Do not use markdown formatting, code blocks, or any other text outside the JSON structure.'
        },
        {
          role: 'user',
          content: prompt
